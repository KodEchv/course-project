...
// Recibe opcionalmente un userId para mostrar el progreso de ese usuario
export const ModulesProgress = ({ userId }: { userId?: string | number }) => {
  // Aquí deberías usar el userId para filtrar los módulos/progresos del usuario
  // Por ahora, solo muestra los módulos de ejemplo
  // TODO: conectar con la API de avances por usuario
  return (
    <div
      className="
        ...
        >
          ...
          <div className="flex items-center justify-between w-full">
            <span className="text-base sm:text-lg font-semibold">
              {mod.nombre} {userId ? `(Usuario ${userId})` : ''}
            </span>
